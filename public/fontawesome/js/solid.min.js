 ...
 */
!(function () {
  let c = {}; let h = {}; try { typeof window !== 'undefined' && (c = window), typeof document !== 'undefined' && (h = document); } catch (c) {} const l = (c.navigator || {}).userAgent; const v = void 0 === l ? '' : l; const z = c; const a = h; const M = (z.document, !!a.documentElement && !!a.head && typeof a.addEventListener === 'function' && a.createElement, ~v.indexOf('MSIE') || v.indexOf('Trident/'), '___FONT_AWESOME___'); const m = (function () { try { return !0; } catch (c) { return !1; } }()); const H = z || {}; H[M] || (H[M] = {}), H[M].styles || (H[M].styles = {}), H[M].hooks || (H[M].hooks = {}), H[M].shims || (H[M].shims = []); const s = H[M]; function V(c, v) {
    const h = (arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}).skipHooks; const l = void 0 !== h && h; const z = Object.keys(v).reduce((c, h) => { const l = v[h]; return l.icon ? c[l.iconName] = l.icon : c[h] = l, c; }, {}); typeof s.hooks.addPack !== 'function' || l ? s.styles[c] = (function (z) {
      for (let c = 1; c < arguments.length; c++) {
        var a = arguments[c] != null ? arguments[c] : {}; let h = Object.keys(a); typeof Object.getOwnPropertySymbols === 'function' && (h = h.concat(Object.getOwnPropertySymbols(a).filter((c) => Object.getOwnPropertyDescriptor(a, c).enumerable))), h.forEach((c) => {
          let h; let l; let v; h = z, v = a[l = c], l in h ? Object.defineProperty(h, l, {
            value: v, enumerable: !0, configurable: !0, writable: !0,
          }) : h[l] = v;
        });
      } return z;
    }({}, s.styles[c] || {}, z)) : s.hooks.addPack(c, z), c === 'fas' && V('fa', v);
  } const L = {
  ...
  }; !(function (c) { try { c(); } catch (c) { if (!m) throw c; } }(() => { V('fas', L); }));
}());
