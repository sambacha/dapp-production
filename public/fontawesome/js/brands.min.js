 ...
 */
!(function () {
  let c = {}; let l = {}; try { typeof window !== 'undefined' && (c = window), typeof document !== 'undefined' && (l = document); } catch (c) {} const z = (c.navigator || {}).userAgent; const h = void 0 === z ? '' : z; const m = c; const v = l; const a = (m.document, !!v.documentElement && !!v.head && typeof v.addEventListener === 'function' && v.createElement, ~h.indexOf('MSIE') || h.indexOf('Trident/'), '___FONT_AWESOME___'); const M = (function () { try { return !0; } catch (c) { return !1; } }()); const s = m || {}; s[a] || (s[a] = {}), s[a].styles || (s[a].styles = {}), s[a].hooks || (s[a].hooks = {}), s[a].shims || (s[a].shims = []); const H = s[a]; function e(c, h) {
    const l = (arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}).skipHooks; const z = void 0 !== l && l; const m = Object.keys(h).reduce((c, l) => { const z = h[l]; return z.icon ? c[z.iconName] = z.icon : c[l] = z, c; }, {}); typeof H.hooks.addPack !== 'function' || z ? H.styles[c] = (function (m) {
      for (let c = 1; c < arguments.length; c++) {
        var v = arguments[c] != null ? arguments[c] : {}; let l = Object.keys(v); typeof Object.getOwnPropertySymbols === 'function' && (l = l.concat(Object.getOwnPropertySymbols(v).filter((c) => Object.getOwnPropertyDescriptor(v, c).enumerable))), l.forEach((c) => {
          let l; let z; let h; l = m, h = v[z = c], z in l ? Object.defineProperty(l, z, {
            value: h, enumerable: !0, configurable: !0, writable: !0,
          }) : l[z] = h;
        });
      } return m;
    }({}, H.styles[c] || {}, m)) : H.hooks.addPack(c, m), c === 'fas' && e('fa', h);
  } const V = {
  ...
  }; !(function (c) { try { c(); } catch (c) { if (!M) throw c; } }(() => { e('fab', V); }));
}());
